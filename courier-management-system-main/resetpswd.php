...
<head>
    ...
    <style>
        body
        {
        background-image:url('images/veri.jpeg');
...
<body>
    <h1 align='center' style="margin: 15px; color:#ccff00;font-weight: bold;font-family:'Times New Roman', Times, serif">VERIFICATION</h1><hr/>
    ...
    <div><h5 ><a href="index.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">SignIn</a></h5></div>
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    <h2 style="color: #ff6a00;">Verify The Following Details</h2>
